...
@section('content')
    ...
    <!-- NEW SECTION: Keiyi Academy Teaser -->
    <section id="academy-teaser" class="section bg-gray-50">
        <div class="container">
            <div class="section-intro text-center">
            ...
            <div class="grid-3">
                <div class="card funky-card border-indigo">
                    <div class="card-icon bg-blue">🧠</div>
                    <span class="tag">Elite</span>
                    <h3>Marketing Elite</h3>
                    <p>Sistemas de venta automatizados, ManyChat, Make y Claude 3.5 en un solo flujo.</p>
                </div>
                <div class="card funky-card border-pink">
                    <div class="card-icon bg-pink">🎬</div>
                ...
                <div class="card funky-card border-yellow">
                    <div class="card-icon bg-yellow">⚡</div>
            ...
            <div class="btn-group centered">
                <a href="{{ route('academy.dashboard') }}" class="btn-primary">Explorar Academia</a>
                @guest
                <a href="{{ route('register') }}" class="btn-outline">Registrarme Gratis</a>
                @endguest
            </div>
        </div>
    </section>
